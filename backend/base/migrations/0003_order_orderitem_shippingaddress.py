# Generated by Django 3.1.7 on 2022-01-08 23:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('freebie', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.freebie')),
